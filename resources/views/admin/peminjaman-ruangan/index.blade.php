        ...
        $(document).ready(function() {
            ...
            $('#peminjamanTable').DataTable({
                ...
                "language": {
                    ...
                    "emptyTable": "<div class='flex flex-col items-center justify-center text-zinc-500'><i class='fas fa-calendar-alt text-4xl mb-3 text-zinc-300'></i><p class='font-medium'>Belum ada data peminjaman.</p></div>",
                    "paginate": {
